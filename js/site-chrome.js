...
<nav class="ellipse-social" aria-label="Social media">
  ...
  function wireBookingLinks() {
    const href = bookingGeneralHref();
    document.querySelectorAll("[data-book-general]").forEach((el) => {
    ...
    if (contactBook) {
      contactBook.setAttribute("href", href);
      if (/^https?:\/\//i.test(href)) {
        contactBook.setAttribute("target", "_blank");
        contactBook.setAttribute("rel", "noopener noreferrer");
      } else {
        contactBook.removeAttribute("target");
        contactBook.removeAttribute("rel");
      }
    }
  }
...
<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out bg-surface/95 backdrop-blur-md border-b border-surface-variant" id="site-header" aria-label="Primary">
  <div class="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 md:py-5 max-w-container-max mx-auto">
    <a class="ellipse-logo ellipse-logo--header shrink-0 hover:opacity-80 transition-opacity" href="/" aria-label="Ellipse Hotels home">
...
<div class="ellipse-mobile-nav" id="mobile-nav" hidden>
  <div class="ellipse-mobile-nav__top">
    <a class="ellipse-logo ellipse-logo--header" href="/" aria-label="Ellipse Hotels home">
...
<footer class="bg-deep-navy text-white py-12 md:py-section-gap border-t border-white/10">
  <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-gutter">
    <div class="md:col-span-4">
      <a class="ellipse-logo ellipse-logo--footer inline-block mb-5 md:mb-6 hover:opacity-90 transition-opacity" href="/" aria-label="Ellipse Hotels home">
    ...
    <div class="md:col-span-2">
      ...
      <ul class="space-y-3 md:space-y-4">
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/">Home</a></li>
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/about">About Us</a></li>
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/rooms">Rooms &amp; Suites</a></li>
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/facilities">Facilities</a></li>
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/gallery">Gallery</a></li>
      </ul>
    </div>
    <div class="md:col-span-2">
      <h4 class="font-label-caps text-label-caps uppercase tracking-widest text-white mb-4 md:mb-6">Contact</h4>
      <ul class="space-y-3 md:space-y-4">
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/contact">Get in Touch</a></li>
        ...
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/terms">Terms</a></li>
      </ul>
    </div>
    <div class="md:col-span-2">
      ...
      <ul class="space-y-3 md:space-y-4">
        ...
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/rooms">Rooms &amp; Suites</a></li>
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/contact">Enquire</a></li>
      </ul>
    </div>
    <div class="md:col-span-2">
      ...
      <ul class="space-y-3 md:space-y-4">
        ...
        <li><a class="font-body-md text-white/70 hover:text-accent-gold transition-colors" href="/contact">Contact</a></li>
      </ul>
    </div>
    <div class="md:col-span-12 mt-6 md:mt-12 pt-5 md:pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
      ...
      <div class="flex gap-6">
        <a class="font-body-md text-sm text-white/50 hover:text-white transition-colors" href="/terms">Terms of Service</a>
        <a class="font-body-md text-sm text-white/50 hover:text-white transition-colors" href="/contact">Privacy &amp; Contact</a>
      </div>
    </div>
  </div>
</footer>`;
...
<button type="button" id="scroll-to-top" class="ellipse-scroll-top" aria-label="Back to top" hidden>
  ...
  function initChrome() {
    ...
    document.addEventListener("click", (e) => {
      const link =
        e.target.closest &&
        e.target.closest('a[href="#book"], a[href="/#book"]');
      if (!link) return;
